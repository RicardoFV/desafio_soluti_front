    ...
    <form @submit.prevent="salvarDados()">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-2">
          ...
          <input type="text" id="uf" disabled="disabled" class="form-control" v-model="empresa.uf" />
        </div>
      </div>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3">
          ...
          <select id="natureza_juridica" v-model="empresa.natureza_juridica" class="form-control">
            ...
            <option
              value="sociedade_de_responsabilidade_limitada"
            >Sociedade de responsabilidade limitada</option>
        ...
        <div class="form-group col-md-6">
          ...
          <input
            type="text"
            id="ramo_atividade"
            v-model="empresa.ramo_atividade"
            class="form-control"
